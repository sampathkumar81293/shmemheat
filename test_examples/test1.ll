...
@.str = private unnamed_addr constant [34 x i8] c"Printing hello from %d within %d\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %4 = call i32 (...) @shmem_init()
  %5 = call i32 (...) @shmem_n_pes()
  store i32 %5, i32* %3, align 4
  %6 = call i32 (...) @shmem_my_pe()
  store i32 %6, i32* %2, align 4
  %7 = load i32, i32* %2, align 4
  %8 = load i32, i32* %3, align 4
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i32 0, i32 0), i32 %7, i32 %8)
  %10 = call i32 (...) @shmem_finalize()
  ret i32 0
}
