...
; <label>:25:                                     ; preds = %22
  ...
  %28 = call i32 (i64*, i64*, i32, i32, ...) bitcast (i32 (...)* @shmem_long_get to i32 (i64*, i64*, i32, i32, ...)*)(i64* %3, i64* %26, i32 1, i32 %27)
  br label %29
...
; <label>:32:                                     ; preds = %22
  ...
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i32 %33, i64 %34)
  %36 = call i32 (...) @shmem_finalize()
  ret i32 0
}
